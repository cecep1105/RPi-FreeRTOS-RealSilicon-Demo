/* font8x8.c - 8x8 monochrome bitmap font, basic Latin U+0000..U+007F.
 *
 * Author: Daniel Hepper <daniel@hepper.net>
 * Based on IBM/Marcel Sondaar public-domain VGA fonts.
 * License: Public Domain.   https://github.com/dhepper/font8x8
 *
 * Encoding: each glyph is 8 bytes, one per row (top->bottom).
 * Within a row byte, the LEAST significant bit is the LEFTMOST pixel.
 */
#include "font8x8.h"
