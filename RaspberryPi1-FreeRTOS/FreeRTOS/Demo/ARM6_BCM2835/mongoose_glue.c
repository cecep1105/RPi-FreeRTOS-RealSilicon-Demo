...
static const char DASH[] =
  ...
  "  <section class=card>\n"
  "    <h2>MARQUEE</h2>\n"
  "    <div class=row><textarea id=m maxlength=500 placeholder='msg (shown uppercase)'></textarea>\n"
  "      <button class=go onclick=\"sendv('m','msg')\">send</button></div>\n"
  "    <div class=row><input id=nm maxlength=5200 placeholder='netmsg (original case)'>\n"
